...
export default function EnvironmentalSustainability() {
  return (
    <div className="px-2 pt-3 sm:pt-5 text-white container mx-auto">
      {/* Heading */}
      <h2 className="text-xl  lg:text-3xl font-bold text-orange-500 mb-6 ">
      ...
      <div className="gap-6 sm:gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-10   gap-4  bg-black rounded-lg shadow-md">
          <div className="flex w-full h-auto max-h-[28rem] col-span-2">
            <img
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-5  gap-4 items-center justify-center  bg-black rounded-lg shadow-md">
        ...
        <div className=" col-span-2">
          ...
          <p className="text-xs md:text-sm xl:text-base text-justify ps-7">
