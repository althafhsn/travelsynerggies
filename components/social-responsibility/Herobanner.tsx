...
export default function HeroBanner() {
  return (
    ...
    >
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 container relative z-10 text-white h-full flex ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 ">
          {/* Text Content */}
          <div className="flex flex-col justify-center space-y-4 sm:space-y-6">
            <h2 className="text-2xl lg:text-4xl font-bold text-orange-500 text-left font-manrope">
