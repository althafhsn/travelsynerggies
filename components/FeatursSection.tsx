...
const Feature = ({ icon, title, description }: FeatureProps) => (
  <div className="border-2 border-white rounded-2xl my-12 p-8 flex flex-col items-center text-center space-y-6 w-[250px] md:w-[320px] h-[300px] md:h-[350px] shadow-lg transition-all duration-500 ease-in-out hover:scale-105 cursor-grabbing ">
