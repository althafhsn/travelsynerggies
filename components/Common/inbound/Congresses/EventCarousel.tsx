...
const eventFeatures = [
    {
        ...
        icon: <FaClipboardList className="text-4xl md:text-6xl lg:text-7xl text-orange-500" />,
    },
    {
        ...
        icon: <FaBullhorn className="text-4xl md:text-6xl lg:text-7xl text-orange-500" />,
    },
    {
            ...
            <div className="container mx-auto px-4 lg:px-8">
                ...
                >
                    {eventFeatures.map((testimonial, index) => (
                        <SwiperSlide key={index} className="h-[5550px]">
                            <div className="bg-gray-900 rounded-lg p-6 lg:p-8 flex flex-col justify-center items-center  min-h-[400px]">
                                <div className="flex flex-col items-center text-center p-4 lg:p-6 rounded-lg">
                                    {testimonial.icon}
                                </div>
