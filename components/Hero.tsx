                    ...
                    <div className="container mx-auto px-8 relative">
                        <div className="grid lg:grid-cols-2 gap-8 lg:text-start px-2">
                            <div className="flex flex-col pt-4 text-center md:text-start">
                                ...
                                <h3 className={`${dancingScript.className} md:text-2xl text-lg`}>Dear Guest,</h3>
                                ...
                                <div className='flex justify-center items-center flex-col md:ps-64'>
                                    <p className={` mt-2 leading-relaxed ${dancingScript.className} md:text-2xl text-lg   text-start text-white pb-4`}>
                                        Yours Sincerely
                                    </p>
                                    <p className='text-lg md:ps-20 font-bold text-orange-500 font-serif'>
